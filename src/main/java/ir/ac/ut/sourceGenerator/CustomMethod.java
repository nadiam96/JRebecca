 ...
 * @author mohammad
 */
public abstract class CustomMethod extends CodeElement {
    ...
    public CustomMethod(String name, String innerBody, String returnType, String accessModifier, List<Class> annotations, List<CustomParameter> params) {
